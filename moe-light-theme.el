...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(company-preview ((,class (:background ,green-00 :foreground ,orange-2))))
   `(company-preview-common ((,class (:background ,green-00 :foreground ,orange-2))))
   `(company-preview-search ((,class (:background ,green-00 :foreground ,orange-2 :bold t))))
   ...
   `(company-tooltip-annotation ((,class (:background ,yellow-00 :foreground ,black-2))))
   `(company-tooltip-annotation-selection ((,class (:background ,green-00 :foreground ,black-2))))
   `(company-tooltip-common ((,class (:background ,green-2 :foreground ,white-0))))
   `(company-tooltip-common-selection ((,class (:background ,green-3 :foreground ,orange-2 :bold t))))
   `(company-tooltip-mouse ((,class (:background ,green-00 :foreground ,black-5))))
   `(company-tooltip-selection ((,class (:background ,green-00 :foreground ,orange-2 :bold t))))
